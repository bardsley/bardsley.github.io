console.log('Attempting to load footer scripts');
//document.getElementsByClassName('bottom')[0].innerHTML = '<div class="bottom-union-wrap"><ul style="width:100%;" class="uk-breadcrumb"><li><a href="/advertise"><i uk-tooltip="pos: left; animation: uk-animation-slide-right-medium;" style="font-size: 4.5rem;" class="ion-easel uk-text-lead hvr-float" aria-expanded="false"></i></a></li><li><a href="/awards"><i uk-tooltip="pos: top; animation: uk-animation-slide-bottom-medium;" style="font-size: 4.5rem;" class="ion-ribbon-a uk-text-lead hvr-float" aria-expanded="false"></i></a></li><li><a href="/jobs"><i uk-tooltip="pos: top; animation: uk-animation-slide-bottom-medium;" style="font-size: 4.5rem;" class="ion-briefcase uk-text-lead hvr-float" aria-expanded="false"></i></a></li><li><a href="/contact"><i uk-tooltip="pos: top; animation: uk-animation-slide-bottom-medium;" style="font-size: 4.5rem;" class="ion-ios-telephone uk-text-lead hvr-float" aria-expanded="false"></i></a></li><li><a href="/environment"><i uk-tooltip="pos: top; animation: uk-animation-slide-bottom-medium;" style="font-size: 4.5rem;" class="ion-earth uk-text-lead hvr-float" aria-expanded="false"></i></a></li><li><a href="privact-policy"><i uk-tooltip="pos: right; animation: uk-animation-slide-left-medium;" style="font-size: 4.5rem;" class="ion-lock-combination uk-text-lead hvr-float" aria-expanded="false"></i></a></li></ul><div class="footer-gif"></div><p class="uk-text-center footer-cp-text uk-margin-large-top">Registered charity number: 1137401 &nbsp; &nbsp; &nbsp; . &nbsp; &nbsp; &nbsp; Copyright © Huddersfield SU 2017</p></div>';

window.addEventListener("load", function () {
    console.log('Load menu sticky relocation');
    var menuWidth = 0;
    if (menuWidth == 0) {
    ...
    function sticky_relocate() {
        console.debug('Relocate the sticky menu');
...
//document.writeln("<script type='text/javascript' src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js'></script>");

window.onload = function () {
    document.writeln("<script type='text/javascript' src='https://cdnjs.cloudflare.com/ajax/libs/move.js/0.5.0/move.min.js'></script>");
}
...
//ISSUE TRACKING
// document.writeln('<script data-trab="f7bf16dff4d0d2f3a70aac52c9383f87" async="async" defer="defer" src="https://my.trab.io/trab.js"></script>');
...
document.writeln("<script type='text/javascript' src='https://cdnjs.cloudflare.com/ajax/libs/uikit/3.0.0-beta.25/js/uikit-icons.min.js'></script>");
...
//document.getElementsByClassName('top-union-wrap')[0].innerHTML = '<div id="sticky-anchor"></div>' + document.getElementsByClassName('top-union-wrap')[0].innerHTML;
var menuWidth = 0;
if (menuWidth == 0){
menuWidth = document.getElementsByClassName('content')[0].offsetWidth;
if (menuWidth > 1200) {
...
'          <li class="uk-active"><a href="#"><i class="ion-icecream"> </i>Active</a></li>' +
'        <li class="uk-parent">' +
'          <a href="#"><i class="ion-coffee"> </i>Parent</a>' +
'<ul uk-accordion>' +

'    <li>' +
'        <a class="uk-parent uk-accordion-title"><i class="ion-crop"> </i> Item 2</a>' +
'        <div class="uk-accordion-content">' +
'            <ul class="uk-nav-sub">' +
'<div class="uk-inline"><li><a href="#"><i class="ion-arrow-down-b"></i>Sub item</a></li><div uk-dropdown="pos: bottom-justify; animation: uk-animation-slide-top-small; duration: 300; mode:click" ><ul class="uk-nav uk-dropdown-nav"><li class=""><a href="#">Active</a></li><li><a href="#">Item</a></li>' +
'<li class="uk-nav-header">Header</li><li><a href="#">Item</a></li><li><a href="#">Item</a></li><li class="uk-nav-divider"></li><li><a href="#">Item</a></li></ul></div></div>' +
'                <li><a href="#">Sub item</a></li>' +
'            </ul>' +
'        </div>' +
'    </li>' +
'    <li>' +
'        <a class="uk-parent uk-accordion-title">Item 2</a>' +
'        <div class="uk-accordion-content">' +
'            <ul class="uk-nav-sub">' +
'                <li><a href="#">Sub item</a></li>' +
'                <li><a href="#">Sub item</a></li>' +
...
'    <li><a href="#"><span class="uk-margin-small-right" uk-icon="icon: trash"></span><i class="ion-pizza"> </i> Item</a></li>' +
'  </ul>' +
*/
...
SWicon.innerHTML = '<input  onchange="handleMenuChange(this);" id="btn-1" type="checkbox"/><label for="btn-1"><span class="hamburger"><span class="line-1"></span><span class="line-2"></span><span class="line-3"></span><span class="cross"></span></span></label>';
var SW = document.createElement('div');
document.getElementsByTagName('body')[0].appendChild(SW);
SW.innerHTML = '  <div id="social-widget" uk-offcanvas="overlay: true">' +
  '         <div class="swCloseBlocker"></div>' +
  '      <div class="uk-offcanvas-bar uk-flex uk-flex-column">' +

  ' <ul class="uk-nav-primary uk-nav-parent-icon" uk-nav> <li class="uk-active"><a href="#" class="hvr-forward"><span class="uk-margin-small-right" uk-icon="icon: settings"></span> Active</a></li><li class="uk-parent"> <a href="#" class="hvr-forward"><span class="uk-margin-small-right" uk-icon="icon: list"></span> Parent</a> <ul class="uk-nav-sub"> <li><a href="#">Sub item</a></li><li><a href="#">Sub item</a></li></ul> </li><li class="uk-parent"> <a href="#" class="hvr-forward"><span class="uk-margin-small-right" uk-icon="icon: hashtag"></span> Parent</a> <ul class="uk-nav-sub"> <li><a href="#">Sub item</a></li><li><a href="#">Sub item</a></li></ul> </li><li> <a href="#" class="hvr-forward" ><span class="uk-margin-small-right" uk-icon="icon: comments"></span> Item</a></li></ul>   </div> </div>';
